...
| Registered tools | 119 | ✅ Counted `toolRegistry.register()` calls |
...
| L3 | Stats claimed "56 Production Tools" — actual count is 119 | HIGH | ✅ Fixed → "119" |
...
| Claim | Reality | Fix |
|-------|---------|-----|
| "56 Production Tools" (landing page, 4 locations) | 119 registered built-in tools (+ dynamic MCP tools) | Changed to "119" everywhere |
| "56 production tools" (metadata description) | Same | Fixed to "119" |
...
| "No API keys needed" | ❌ External providers require API keys; Ollama can run locally |
...
| 5 | `apps/web/src/app/page.tsx` | Section header "56 Production Tools" → "119" | Honesty |
| 6 | `apps/web/src/app/page.tsx` | Footer "56 production tools" → "119" | Honesty |
| 7 | `apps/web/src/app/layout.tsx` | Metadata description "56" → "119" | Honesty |
...
- **Dishonest landing page** — claimed 56 tools when 119 exist ("119" now)
