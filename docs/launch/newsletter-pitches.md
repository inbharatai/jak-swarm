...
**Subject:** Open-source multi-agent AI platform: 38 agents, 112 tools, 6 providers (MIT licensed)

Hi Rundown team,

I just open-sourced JAK Swarm, a multi-agent AI platform that lets developers orchestrate 33 specialized AI agents working together on complex tasks. It supports 112 tools and 6 LLM providers (OpenAI, Anthropic, Google, Mistral, Ollama, Groq), and runs fully locally with Ollama for developers who need data privacy.
...
I'd love to share JAK Swarm with your readers. It's an open-source (MIT) multi-agent AI platform built in Python with 38 pre-built agents, 112 tools, and support for 6 LLM providers including full Ollama support for local execution.
...
I just released JAK Swarm, an open-source platform where multiple AI agents collaborate on complex tasks -- like having a team of AI specialists instead of one generalist. It ships with 38 agents, 112 tools, and works with 6 different LLM providers.
...
I'd like to pitch JAK Swarm for your readers. It's an open-source multi-agent AI platform that I've been building for 14 months. The platform ships with 38 pre-built agents, 112 tools, and support for 6 LLM providers.
...
I'm reaching out about JAK Swarm, a multi-agent AI platform I just open-sourced after 14 months of development. It ships with 38 agents, 112 tools, and works with 6 LLM providers including local execution through Ollama.
...
I'd like to share JAK Swarm with your readers. It's a free, open-source multi-agent AI platform that ships with 33 ready-to-use agents, 112 tools, and support for 6 LLM providers.
