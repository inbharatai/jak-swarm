...
**Subject:** Open-source multi-agent AI platform: 33 agents, 79 tools, 6 providers (MIT licensed)

Hi Rundown team,

I just open-sourced JAK Swarm, a multi-agent AI platform that lets developers orchestrate 33 specialized AI agents working together on complex tasks. It supports 79 tools and 6 LLM providers (OpenAI, Anthropic, Google, Mistral, Ollama, Groq), and runs fully locally with Ollama for developers who need data privacy.
...
Quick pitch for your readers: I built JAK Swarm, an open-source multi-agent AI platform where 33 specialized agents collaborate on tasks using 79 tools and any of 6 LLM providers. Think of it as building an AI team instead of making one AI do everything.
...
**Subject:** Show TLDR: Multi-agent AI platform with 33 agents, works with Ollama locally

Hi TLDR team,

I'd love to share JAK Swarm with your readers. It's an open-source (MIT) multi-agent AI platform built in Python with 33 pre-built agents, 79 tools, and support for 6 LLM providers including full Ollama support for local execution.
...
**Subject:** Launching an open-source AI swarm: 33 agents that work together

Hi AI Breakfast team,

I just released JAK Swarm, an open-source platform where multiple AI agents collaborate on complex tasks -- like having a team of AI specialists instead of one generalist. It ships with 33 agents, 79 tools, and works with 6 different LLM providers.
...
**Subject:** Open-sourcing 14 months of work: multi-agent AI with 33 agents

Hi Neuron team,

I'm sharing JAK Swarm, an open-source multi-agent AI platform I've been building for the past 14 months. It ships with 33 specialized agents, 79 tools, and supports 6 LLM providers -- including full local execution via Ollama.
...
**Subject:** Multi-agent orchestration platform: 33 agents, simple architecture, MIT licensed
...
I'd like to pitch JAK Swarm for your readers. It's an open-source multi-agent AI platform that I've been building for 14 months. The platform ships with 33 pre-built agents, 79 tools, and support for 6 LLM providers.
...
I just launched JAK Swarm, an open-source multi-agent AI platform that runs entirely locally. 33 specialized agents, 79 tools, 6 LLM providers -- including Ollama for complete on-device execution with no API keys required.
...
I'm reaching out about JAK Swarm, a multi-agent AI platform I just open-sourced after 14 months of development. It ships with 33 agents, 79 tools, and works with 6 LLM providers including local execution through Ollama.
...
**Subject:** New AI tool: JAK Swarm -- orchestrate 33 agents with any LLM provider

Hi AI Tool Report team,

I'd like to share JAK Swarm with your readers. It's a free, open-source multi-agent AI platform that ships with 33 ready-to-use agents, 79 tools, and support for 6 LLM providers.
