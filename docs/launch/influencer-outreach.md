...
Hey Jeff, I'm a solo developer from India who just open-sourced JAK Swarm -- a multi-agent AI platform with 39 agents, 119 tools, and support for 6 LLM providers including fully local execution via Ollama.
...
Hi Andrej, I built JAK Swarm, an open-source multi-agent AI platform. 39 specialized agents, 119 tools, 6 LLM providers, under 15K lines of Python.
...
39 agents, 119 tools, MIT licensed: github.com/inbharatai/jak-swarm
...
Hi Lenny, I'm a solo developer from India who just open-sourced a multi-agent AI platform called JAK Swarm (39 agents, 119 tools, 6 LLM providers).
...
Hey Mckay, I just open-sourced JAK Swarm -- a multi-agent AI platform with 39 agents, 119 tools, and 6 LLM providers.
...
39 agents, 119 tools, 6 providers, MIT licensed: github.com/inbharatai/jak-swarm
...
The approach: 39 specialized agents communicate through shared context, delegate dynamically, and use different LLM providers per agent. The architecture is intentionally narrow (just orchestration, not a full LLM framework) and simple (under 15K lines, no complex abstractions).
...
**Why:** Simon Willison is one of the most respected voices in the Python/open-source community. His blog posts about tools get enormous developer attention. He values practical, well-engineered tools and honest documentation.

**DM (Twitter):**

Hi Simon, I built JAK Swarm, an open-source (MIT) multi-agent AI platform in Python. 39 agents, 119 tools, 6 LLM providers, under 15K lines.
