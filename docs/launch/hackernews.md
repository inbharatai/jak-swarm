...
Show HN: JAK Swarm -- Open-source multi-agent AI platform (38 agents, 119 tools, 6 LLM providers)
...
I've been building JAK Swarm for the past 14 months and wanted to share it with you. It's an open-source (MIT) multi-agent AI platform written in TypeScript.
...
- 6 LLM providers (OpenAI, Anthropic, Google, DeepSeek, OpenRouter, Ollama)
...
There's no message queue, no distributed systems layer, no complex middleware. The monorepo is deliberately simple and readable.
...
- PostgreSQL + Prisma
- Redis for queues, sessions, and coordination
