          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <div className="flex w-full sm:w-auto flex-col sm:flex-row items-center gap-3">
              <a
                ...
                className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-emerald-300/30 bg-emerald-400/10 px-6 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-emerald-400/15 hover:border-emerald-200/50"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-sky-300/30 bg-sky-400/10 px-6 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-sky-400/15 hover:border-sky-200/50"
