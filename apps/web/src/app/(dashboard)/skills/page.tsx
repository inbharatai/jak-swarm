...
const SKILL_MARKETPLACE = [
  ...
  { id: 'email-threat-detector', name: 'Email Threat Detector', description: 'Detect phishing, spoofing, BEC, credential harvesting, and social engineering in emails. 4-layer analysis: rules → AI → premium → human review. (analyze_email_risk tool)', tier: 1, riskLevel: 'LOW', category: 'Security' },
