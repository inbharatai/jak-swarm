    ...
    <main className="min-h-screen bg-background text-foreground px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose dark:prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <h2 className="text-xl font-display font-semibold text-foreground">1. What We Collect</h2>
          ...
          <h2 className="text-xl font-display font-semibold text-foreground">2. How We Use Your Data</h2>
          ...
          <h2 className="text-xl font-display font-semibold text-foreground">3. Data Storage & Security</h2>
          ...
          <h2 className="text-xl font-display font-semibold text-foreground">7. Open Source</h2>
